...
## Библиотеки для работы с 2D/3D графикой и игровые движки с открытым исходным кодом

* [g4d](https://github.com/KanzakiKino/g4d)
...
* [Эмулятор NES (порт с языка go)](https://github.com/blahness/nes)
* [d2dgame](https://github.com/WebFreak001/D2DGame)
* [unecht](https://github.com/Extrawurst/unecht)
* [Dash (заброшен)](https://github.com/Circular-Studios/Dash)
